...
class customerSpec(unittest.TestCase):
    ...
    def it_decorates_a_person(self):
        #should work
        self.a_customer_decorator.decorate(self.a_person)
        self.a_customer_decorator.decorated |should| be(self.a_person)
        self.a_customer_decorator.decorated |should| have(1).decorators
        #should fail
        non_person = 'I am not a person'
        (self.a_customer_decorator.decorate, non_person) |should| throw(AssociationError)
