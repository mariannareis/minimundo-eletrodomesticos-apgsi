...
from appliances_store import Product, Customer, Purchase, Exchange, StorageProducts, StorageCustomers
...
class TestProduct(unittest.TestCase):
    ...
    def test_add_one_product(self):
        ...
        StorageProducts.all_products[0].serial_number |should| equal_to ("SN-3122")
...
class TestCustomer(unittest.TestCase):
    ...
    def test_add_one_customer(self):
        ...
        len(StorageCustomers.all_customers) |should| equal_to (1)
...
class TestPurchase(unittest.TestCase):
    ...
    def test_verify_a_purchase_that_is_not_under_warranty(self):
        ...
        self.purchase.add_product(1)
        self.purchase.products |should| equal_to([1, 1])
        self.purchase.is_my_purchase_in_the_warranty(1) |should| equal_to(False)
